...
namespace MoRoC.Classes
{
    public class CPU
    {
                ...
                if (hardwareItem.HardwareType == HardwareType.Cpu)
                {
                    foreach (var sensor in hardwareItem.Sensors)
                    {
                        if (sensor.SensorType == SensorType.Temperature)
                        {
                            ...
                            if (sensor.Name.Contains("Package") || sensor.Name.Contains("Tdie") || sensor.Name.Contains("Average"))
                            {
                                return;
                            }
                        }
        ...
        {
            Fans.Clear();
            void CollectSensors(IHardware hardware, List<ISensor> sensors)
            {
            ...
            {
                CollectSensors(hardware, allFanSensors);
            }
